...
def rotate_matrix_minimun():
	...
	zipped_list = zip(reversed_order) # zip() repeatedly consumes one item from the beginning of each of its arguments and makes a tuple from it, until there are no more items,
